...
## Большой прогон по странице «экраны»

Полуверифицированный многоагентный прогон (189 экранов, 412 находок) вынесен отдельно, чтобы не дублировать здесь:
- `screens-audit.md` — человекочитаемая сводка дефектов по паттернам (частотность, примеры, правки).
- `screens-audit.json` — полные данные всех 412 находок, включая 52 эвристики (машинный формат).
